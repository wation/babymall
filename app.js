...
App({
  ...
  onPageShow: function () {
    ...
    if (pageInstance.need_login && !this.getUserInfo().phone) {
      ...
      : this.goLogin({ 
          success: function () {
            !that.getUserInfo().phone && that.turnToPage('/default/pages/bindCellphone/bindCellphone');
          }
        });
    }
...
    return  s;
  ...
  globalData:{
    appId: 'advdD2KD53',
        tabBarPagePathArr: '["/pages/fVVY0Fw2ZP_page10000/fVVY0Fw2ZP_page10000","/pages/fVVY0Fw2ZP_page10020/fVVY0Fw2ZP_page10020","/pages/tabbarShoppingCart/tabbarShoppingCart","/pages/fVVY0Fw2ZP_page10002/fVVY0Fw2ZP_page10002"]',
        homepageRouter: 'fVVY0Fw2ZP_page10000',
    formData: null,
    userInfo: {},
    systemInfo: null,
    sessionKey: '',
