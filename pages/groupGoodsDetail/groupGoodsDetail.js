...
Page({
  ...
  onShareAppMessage: function () {
    var that = this,
      ...
      url = '/pages/groupGoodsDetail/groupGoodsDetail?detail=' + goodsId + '&contact=' + contact + (franchiseeId ? '&franchisee=' + franchiseeId + '&cart_num=' + cart_num : '');
  ...
  groupBuyDirectlyNextStep: function (e) {
    ...
    app.sendRequest({
      ...
      success: function (res) {
        var cart_arr = [res.data],
          pagePath = '/eCommerce/pages/previewGoodsOrder/previewGoodsOrder?cart_arr=' + encodeURIComponent(cart_arr) + '&is_group=true';
